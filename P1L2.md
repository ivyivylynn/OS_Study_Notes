...
<img width="500" src="/images/P1L2/a59529d2.png">
...
- **Resource Management**
    - Here are some hardware components
     ![wh_is_os.png](/images/P1L2/899eff40.png)
...
![os_element.png](/images/P1L2/1cc6afb6.png)
...
![design_principle_os.png](/images/P1L2/7de39dba.png)
...
- **User Mode:** unprivileged
    - Applications
![unprivileged_usermode.png](/images/P1L2/aa3b6adf.png)
...
![priviledged_kernel_mode.png](/images/P1L2/e630f928.png)
...
![sys_call1.png](/images/P1L2/715675b8.png)
...
![syscall2.png](/images/P1L2/fca89f3b.png)
...
![sample_sys_calls.png](/images/P1L2/aa7b5830.png)
...
![monolithic_os.png](/images/P1L2/6e77ec7d.png)
...
![modular_os.png](/images/P1L2/39c650b1.png)
...
![microkernel_os.png](/images/P1L2/594f85cc.png)
...
![linux-arch.png](/images/P1L2/3222914e.png)

##### Linux Kernel Components

![linux-kernel.png](/images/P1L2/84ac576c.png)

Each of the components can be independently modified or replaced.

#### Mac OSX

![mac_osx.png](/images/P1L2/b345be2e.png)
